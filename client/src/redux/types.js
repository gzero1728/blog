...
// POST DETAIL LOADING
export const POST_DETAIL_LOADING_REQUEST = "POSTDETAIL_LOADING_REQUEST";
export const POST_DETAIL_LOADING_SUCCESS = "POSTDETAIL_LOADING_SUCCESS";
export const POST_DETAIL_LOADING_FAILURE = "POSTDETAIL_LOADING_FAILURE";

// POST DELETE
export const POST_DELETE_REQUEST = "POSTDELETE_REQUEST";
export const POST_DELETE_SUCCESS = "POSTDELETE_SUCCESS";
export const POST_DELETE_FAILURE = "POSTDELETE_FAILURE";