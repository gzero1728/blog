...
// POST UPLOAD
export const POST_UPLOADING_REQUEST = "POST_UPLOADIN_REQUEST";
export const POST_UPLOADING_SUCCESS = "POST_UPLOADIN_SUCCESS";
export const POST_UPLOADING_FAILURE = "POST_UPLOADIN_FAILURE";